...
import Img1 from "../assets/img/avatar-anisha.png";
import Img2 from "../assets/img/avatar-ali.png";
    ...
    return (
        <section id="testimonials">
            <div className="max-w-6xl px-5 mx-auto mt-32 text-center">
                ...
                >
                    <img src={Img2} className="w-16 -mt-14" alt="" />
                ...
                <div
                    className="hidden flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:flex md:w-1/3"
                >
                    <img src={Img3} className="w-16 -mt-14" alt="" />
